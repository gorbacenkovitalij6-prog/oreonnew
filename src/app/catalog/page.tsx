...
export default function CatalogPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8 py-8 md:py-12 pt-20 md:pt-24">
        <h1 className="text-4xl md:text-5xl font-bold text-[#0A2540] mb-6 md:mb-8">Каталог автомобилей</h1>
            ...
            {filteredCars.map((car) => (
              <div key={car.id} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <p className="text-sm md:text-base text-gray-700 mb-4 line-clamp-2">{car.description}</p>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="text-2xl md:text-3xl font-bold text-[#0A7ABF]">
                    ...
                    >
                      <Button className="w-full bg-[#0A7ABF] hover:bg-[#095A8F]">
                        Подробнее
                      </Button>
                    </a>
                  </div>
