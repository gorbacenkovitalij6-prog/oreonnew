...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="flex flex-col lg:flex-row items-stretch pt-[60px] lg:pt-[90px] bg-gray-50 lg:bg-white relative">
        
        {/* Mobile Heading (Hidden on Desktop) */}
        <div className="w-full lg:hidden px-4 pt-8 pb-6 flex flex-col items-center text-center bg-white z-10 relative shadow-sm">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#0A2540] leading-tight mb-3">
            АВТО ИЗ ЕВРОПЫ С ДОСТАВКОЙ ПО РФ
          </h1>
        ...
        {/* Image Side (Shows in middle on mobile, right on desktop) */}
        <div className="w-full lg:w-1/2 relative lg:order-last z-0">
          <div className="relative w-full h-[280px] sm:h-[400px] lg:h-[600px] xl:h-[750px]">
            <img
              src="https://i.ibb.co/99MMvGWQ/Gemini-Generated-Image-c24usmc24usmc24u.jpg"
              alt="Ореон - авто из Европы"
              className="w-full h-full object-cover"
            />
            {/* Gradient to blend image into the gray background at the bottom on mobile */}
            <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-gray-50 to-transparent lg:hidden" />
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/40 to-black/60 hidden lg:block" />

            {/* Desktop Action Buttons (Hidden on mobile) */}
            <div className="hidden lg:flex absolute bottom-8 left-8 right-8 gap-4 items-center justify-center z-10">
              <Button
                onClick={() => setContactDialogOpen(true)}
                className="bg-white text-[#BF360C] hover:bg-gray-100 flex-1 max-w-[300px] h-16 px-6 text-base font-semibold rounded-lg shadow-lg transition-all hover:scale-105 whitespace-nowrap flex items-center justify-center"
              >
              ...
              <a
                ...
                className="bg-[#0088cc] hover:bg-[#0077b3] text-white flex-1 max-w-[300px] h-16 px-6 text-base font-semibold rounded-lg shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2 whitespace-nowrap"
              >
        ...
        {/* Form Container (Bottom on mobile, left on desktop) */}
        <div className="relative w-full lg:w-1/2 flex items-center lg:items-start justify-center px-4 sm:px-10 lg:py-20 xl:py-32 z-10 -mt-10 sm:-mt-16 lg:mt-0 pb-10 lg:pb-0">
          <div className="max-w-xl w-full flex flex-col bg-white lg:bg-transparent rounded-2xl shadow-xl lg:shadow-none p-5 sm:p-8 lg:p-0 border border-gray-100 lg:border-none relative">
            ...
            <form onSubmit={handleHeroFormSubmit} className="space-y-4">
              <Input
                ...
                required
                className="h-12 bg-gray-50 lg:bg-gray-50 border-gray-200 text-gray-900 text-sm placeholder:text-gray-500 rounded-lg"
              />

              <div className="flex gap-2">
                <div className="flex items-center gap-2 h-12 px-4 bg-gray-50 border border-gray-200 rounded-lg shrink-0">
                  <span className="text-xl leading-none">🇷🇺</span>
                  <span className="text-gray-700 font-semibold text-sm">+7</span>
                </div>
                <IMaskInput
                  mask="(000) 000-00-00"
                  ...
                  unmask={true}
                  onAccept={(value) => setHeroFormData({ ...heroFormData, phone: value as string })}
                  required
                  className="h-12 bg-gray-50 border-gray-200 border text-gray-900 text-sm flex-1 px-3 placeholder:text-gray-500 rounded-lg focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                />
              </div>
              ...
              <Select
                ...
                required
              >
                <SelectTrigger className="h-12 bg-gray-50 border-gray-200 text-gray-900 text-sm rounded-lg lg:bg-gray-50">
              ...
              <Button
                ...
                className="w-full h-12 bg-[#0A7ABF] hover:bg-[#095A8F] text-white text-base font-bold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg transition-transform active:scale-[0.98]"
              >
              ...
              <div className="flex items-start gap-2.5 pt-2">
                ...
                >
                  ...
                  <span className="underline decoration-gray-300 underline-offset-2">пользовательского соглашения</span>
                </label>
              </div>
            </form>

            {/* Mobile Action Buttons below the form */}
            <div className="w-full flex lg:hidden flex-col sm:flex-row gap-3 mt-8">
              <Button
                onClick={() => setContactDialogOpen(true)}
                className="w-full sm:flex-1 bg-white border border-[#BF360C]/20 text-[#BF360C] hover:bg-gray-50 px-6 h-[56px] text-sm font-semibold rounded-xl shadow-md transition-all whitespace-normal sm:whitespace-nowrap flex items-center justify-center"
              >
                Запросить договор
              </Button>
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => trackEvent('telegram_click')}
                className="w-full sm:flex-1 bg-[#0088cc] hover:bg-[#0077b3] text-white px-6 h-[56px] text-sm font-semibold rounded-xl shadow-md transition-all flex items-center justify-center gap-2 whitespace-normal sm:whitespace-nowrap"
              >
      ...
      <section className="py-8 lg:py-12 px-4 lg:px-8 bg-gray-50">
        <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0A2540] leading-tight">
              КЛИЕНТЫ, КОТОРЫЕ<br className="hidden lg:block" />
              {' '}УЖЕ ПОЛУЧИЛИ АВТО
            </h2>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center lg:items-end gap-4 w-full">
            <div className="flex items-center justify-center lg:justify-end -space-x-3 lg:-space-x-4 max-w-full overflow-x-auto py-2">
              {/* Client photos */}
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-pink-400 to-pink-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center overflow-hidden">
                <img
              ...
              {/* Counter Badge */}
              <div className="w-16 h-16 lg:w-24 lg:h-24 shrink-0 rounded-full border-2 lg:border-4 border-white bg-[#0A7ABF] flex flex-col items-center justify-center">
                <div className="text-white font-bold text-xs lg:text-lg leading-tight lg:leading-normal">1000+</div>
                <div className="text-white text-[10px] lg:text-xs">чел.</div>
              </div>
            </div>
      ...
      <section className="py-12 px-8 bg-gray-50">
        <div className="max-w-screen-2xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#0A2540] mb-6 lg:mb-8 text-center lg:text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm flex flex-col md:grid md:grid-cols-2">
                <img
                  src="https://i.ibb.co/213tpzZq/photo-2026-02-12-13-08-12.jpg"
                  alt="Передача автомобиля"
                  className="w-full h-full object-cover"
                />
                <div className="p-5 flex flex-col justify-center order-last md:order-none">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm flex flex-col md:grid md:grid-cols-2">
                ...
                <img
                  ...
                  className="w-full h-full object-cover h-64 md:h-full"
                />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-[#00A651] to-[#00C853] rounded-lg p-6 text-center shadow-lg">
              ...
              <Button
                onClick={() => setContactDialogOpen(true)}
                className="w-full sm:w-auto bg-white text-[#00A651] hover:bg-gray-100 px-4 sm:px-8 py-4 sm:py-6 text-sm sm:text-lg font-semibold shadow-md whitespace-normal h-auto"
              >
...
function ConsultationFormSection() {
  ...
  return (
    <section className="py-8 lg:py-12 px-4 sm:px-8 bg-white">
      <div className="max-w-screen-2xl mx-auto">
        <div className="bg-[#BF360C] rounded-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 p-6 lg:p-12">
            ...
            <div className="text-white">
              <h2 className="text-2xl lg:text-4xl font-bold mb-6 lg:mb-8 leading-tight">
                ПОЛУЧИТЕ БЕСПЛАТНУЮ КОНСУЛЬТАЦИЮ<br className="hidden lg:block" />
